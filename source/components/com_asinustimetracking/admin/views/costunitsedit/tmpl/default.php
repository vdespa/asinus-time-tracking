...
<form action="" method="post" name="adminForm" id="adminForm" class="form-validate">
	<input type="hidden" name="ccid" value="<?php echo $this->costCenter->cc_id; ?>" />
	<input type="hidden" name="task" value="savecostunit" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="text_area" type="text" name="description" size="32" maxlength="30"
							value="<?php echo $this->costCenter->description; ?>">
					</div>
				</div>
			</div>
			<div class="span3">
