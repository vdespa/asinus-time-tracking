...
class AsinusTimeTrackingViewRoles extends JView{
	function display($tpl = null){
		JToolBarHelper::title( JText::_('COM_ASINUSTIMETRACKING_TOOLBAR_ROLES'), 'generic.png');
		JToolBarHelper :: addNewX('rolesedit', JText::_("COM_ASINUSTIMETRACKING_NEW"));
		JToolBarHelper :: deleteListx(JText::_("COM_ASINUSTIMETRACKING_Q_REMOVE") ,'removerole',JText::_('COM_ASINUSTIMETRACKING_REMOVE'));
