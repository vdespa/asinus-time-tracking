...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div id="editcell">
		<table class="adminlist">
			...
			<tr>
				...
				<th width="150"><?php echo JText::_('COM_ASINUSTIMETRACKING_COSTUNIT'); ?></th>
				<th width="*"></th>
			</tr>
			</thead>
			<?php
			...
			for($i=0, $n=count($this->items); $i < $n; $i++){
				$row =& $this->items[$i];
				$checked 	= JHTML::_('grid.id',   $i, $row->cc_id );
				$link 		= JRoute::_( 'index.php?option=com_asinustimetracking&task=costunitsedit&cid[]='. $row->cc_id );
				?>
	...
	<input type="hidden" name="task" value="costunits" /> <input type="hidden"
